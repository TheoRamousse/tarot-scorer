...
namespace TarotDB_UT
{
    class TarotContextStub : TarotContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PlayerBiddingEntity>().HasData(new { Bidding = Bidding.Opponent, GameId = (long)4, PlayerId = (long)15});
            ...
            modelBuilder.Entity<PlayerBiddingEntity>().HasData(new { Bidding = Bidding.Opponent, GameId = (long)5, PlayerId = (long)9});
